"""
Designed to make file mananging easier. This is just the multiplication room setup function.
...
def setupMultiplicationRoom(self):
    map_name = "maps/Urban-Area.tmx"
    room_operator = "*"
